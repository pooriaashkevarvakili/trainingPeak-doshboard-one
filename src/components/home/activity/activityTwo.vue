<!-- =========================================================================================
    File Name: activityTwo.vue
    Description: activityTwo Component
    Component Name: activityTwo
    ----------------------------------------------------------------------------------------
    Item Name: Vo2CyclingAcademy - Technology Dep.
      Author: pooriavakili
========================================================================================== -->
<template>
    <q-card class="q-mr-sm q-mt-sm" style="background-color: #FBEAEA;width:370px;height:130px">
        <q-card-section>
            <div class="row">
                <div class="col">
                    <div class="flex">
...
async function routerChange() {
    await axios.get('http://localhost:4000/workoutsOne', {
